...
import { createAddContactThunkAction, createUpdateContactThunkAction, createUnEditContactAction } from '../state/contactsActions';
...
const ContactForm = ({ c }) => {
    ...
    const formSubmitted = e => {
        ...
        dispatch(isEditing ? createUpdateContactThunkAction(c) : createAddContactThunkAction(c));
