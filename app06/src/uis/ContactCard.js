...
import { createEditContactAction, createDeleteContactThunkAction } from '../state/contactsActions';
        ...
        <div className='card m-0'>
            ...
            <div className='card-footer text-end'>
                ...
                <button type="button" className="btn btn-sm btn-danger"
                    onClick={e => dispatch(createDeleteContactThunkAction(c.id))} >DELETE</button>
            </div>
        </div>
    );
};
